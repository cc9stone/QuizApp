...
import com.azamovhudstc.quizapp.presenter.model.HistoryModel;
...
public class FinalResultActivity extends AppCompatActivity {
    private TextView tvSubject, tvCorrect, tvIncorrect, tvWellDone;
...
//        final ConfettiSource confettiSource = new ConfettiSource(containerMiddleX, containerMiddleY);
        ...
        if (attempt.getCorrect() > 5) {
            ...
            tvWellDone.setText("Хорошо," + quizPref.getName());
        } else {
            tvWellDone.setText("Так себе," + quizPref.getName());
